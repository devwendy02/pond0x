...
(self.webpackChunk_N_E = self.webpackChunk_N_E || []).push([
    [375], {
        ...
        4649: function(t, e, n) {
            ...
            var i, s, c, a, r, o, h, l, d, u, p, w, f, m, v, g, C, y, U, b, k = n(3162),
                E = n(6450),
                S = n(2375),
                I = n(5818),
                P = n(7224),
                ...
                $ = class extends S.wR {
                    constructor(t) {
                        ...
                        }), (0, S.Ko)(this, c), (0, S.Ko)(this, r), (0, S.Ko)(this, h), (0, S.Ko)(this, d), (0, S.Ko)(this, p), (0, S.Ko)(this, f), (0, S.Ko)(this, v), (0, S.Ko)(this, C), (0, S.Ko)(this, U), (0, S.ov)(this, "id", "walletConnect"), (0, S.ov)(this, "name", "WalletConnect"), (0, S.ov)(this, "ready", !0), (0, S.Ko)(this, i, void 0), (0, S.Ko)(this, s, void 0), (0, S.ov)(this, "onAccountsChanged", t => {
                        ...
                        try {
                            ...
                            if (i.session && s && await i.disconnect(), !i.session || s) {
                                ...
                                this.emit("message", {
                                    ...
                                    chains: [n],
                                    optionalChains: t
                                }), (0, S.U9)(this, f, m).call(this, this.chains.map(({
                                    id: t
                                }) => t))
                            }
                    ...
                    async getWalletClient({
                        ...
                        let [e, n] = await Promise.all([this.getProvider({
                            chainId: t
                        }), this.getAccount()]), i = this.chains.find(e => e.id === t);
                    ...
                    async isAuthorized() {
                        try {
                            let [t, e] = await Promise.all([this.getAccount(), this.getProvider()]), n = (0, S.U9)(this, h, l).call(this);
                            if (!t) return !1;
                            if (n && e.session) {
                                try {
                                    await e.disconnect()
            ...
            i = new WeakMap, s = new WeakMap, c = new WeakSet, a = async function() {
                return (0, S.ac)(this, s) || "undefined" == typeof window || (0, S.qx)(this, s, (0, S.U9)(this, r, o).call(this)), (0, S.ac)(this, s)
            }, r = new WeakSet, o = async function() {
                let {
                    default: t,
                    OPTIONAL_EVENTS: e,
                    OPTIONAL_METHODS: s
                } = await Promise.all([n.e(26), n.e(804)]).then(n.bind(n, 1026)), [c, ...a] = this.chains.map(({
                    id: t
                }) => t);
                if (c) {
                    let {
            ...
            }, d = new WeakSet, u = function() {
                (0, S.ac)(this, i) && ((0, S.U9)(this, p, w).call(this), (0, S.ac)(this, i).on("accountsChanged", this.onAccountsChanged), (0, S.ac)(this, i).on("chainChanged", this.onChainChanged), (0, S.ac)(this, i).on("disconnect", this.onDisconnect), (0, S.ac)(this, i).on("session_delete", this.onDisconnect), (0, S.ac)(this, i).on("display_uri", this.onDisplayUri), (0, S.ac)(this, i).on("connect", this.onConnect))
            }, p = new WeakSet, w = function() {
                (0, S.ac)(this, i) && ((0, S.ac)(this, i).removeListener("accountsChanged", this.onAccountsChanged), (0, S.ac)(this, i).removeListener("chainChanged", this.onChainChanged), (0, S.ac)(this, i).removeListener("disconnect", this.onDisconnect), (0, S.ac)(this, i).removeListener("session_delete", this.onDisconnect), (0, S.ac)(this, i).removeListener("display_uri", this.onDisplayUri), (0, S.ac)(this, i).removeListener("connect", this.onConnect))
            ...
            class q {
                constructor(t, e) {
                    this.wagmi = {}, this.chains = [], this.namespace = "eip155", this.disconnect = k.zP, this.getAccount = k.D0, this.watchAccount = k.uH, this.fetchBalance = k.EG, this.getNetwork = k.Hy, this.watchNetwork = k.QC, this.switchNetwork = k.If, this.fetchEnsName = k.Lk, this.fetchEnsAvatar = k.w6, this.wagmi = t, this.chains = e
                }
                ...
                return function({
                    ...
                    rpc: e => {
                        ...
                        return [1, 3, 4, 5, 10, 42, 56, 69, 97, 100, 137, 280, 324, 420, 42161, 42220, 43114, 80001, 421611, 421613, 1313161554, 1313161555].includes(e.id) ? {
                            ...
                            http: e.rpcUrls.default.http[0],
                            webSocket: null == (n = e.rpcUrls.default.webSocket) ? void 0 : n[0]
                        }
                    }
                })
            }
