    ...
    [330], {
        8421: function(e, t) {
            ...
            t.byteLength = function(e) {
                ...
                for (var t, n = e.length, i = n % 3, s = [], o = 0, a = n - i; o < a; o += 16383) s.push(function(e, t, n) {
        ...
        8504: function(e, t, r) {
            ...
            t.lW = a, t.h2 = 50, a.TYPED_ARRAY_SUPPORT = function() {
                ...
                if (F(e, Uint8Array) && (e = a.from(e, e.offset, e.byteLength)), F(t, Uint8Array) && (t = a.from(t, t.offset, t.byteLength)), !a.isBuffer(e) || !a.isBuffer(t)) throw TypeError('The "buf1", "buf2" arguments must be one of type Buffer or Uint8Array');
                if (e === t) return 0;
                let r = e.length,
                    n = t.length;
            ...
            }, s && (a.prototype[s] = a.prototype.inspect), a.prototype.compare = function(e, t, r, n, i) {
            ...
            function M(e, t, r, n, i, s) {
                if (e > r || e < t) {
                    ...
                    throw n = s > 3 ? 0 === t || t === BigInt(0) ? `>= 0${i} and < 2${i} ** ${(s+1)*8}${i}` : `>= -(2${i} ** ${(s+1)*8-1}${i}) and < 2 ** ${(s+1)*8-1}${i}` : `>= ${t}${i} and <= ${r}${i}`, new B.ERR_OUT_OF_RANGE("value", n, e)
                }
            ...
            x("ERR_BUFFER_OUT_OF_BOUNDS", function(e) {
                ...
                let n = `The value of "${e}" is out of range.`,
                    i = r;
                return Number.isInteger(r) && Math.abs(r) > 4294967296 ? i = S(String(r)) : "bigint" == typeof r && (i = String(r), (r > BigInt(2) ** BigInt(32) || r < -(BigInt(2) ** BigInt(32))) && (i = S(i)), i += "n"), n += ` It must be ${t}. Received ${i}`
            }, RangeError);
            let k = /[^+/0-9A-Za-z-_]/g;
        ...
        6701: function(e, t) { /*! ieee754. BSD-3-Clause License. Feross Aboukhadijeh <https://feross.org/opensource> */
            t.read = function(e, t, r, n, i) {
                ...
                var o, a, u, c = 8 * s - i - 1,
                    ...
                    p = n ? 1 : -1,
                    g = t < 0 || 0 === t && 1 / t < 0 ? 1 : 0;
                for (isNaN(t = Math.abs(t)) || t === 1 / 0 ? (a = isNaN(t) ? 1 : 0, o = l) : (o = Math.floor(Math.log(t) / Math.LN2), t * (u = Math.pow(2, -o)) < 1 && (o--, u *= 2), o + f >= 1 ? t += h / u : t += h * Math.pow(2, 1 - f), t * u >= 2 && (o++, u /= 2), o + f >= l ? (a = 0, o = l) : o + f >= 1 ? (a = (t * u - 1) * Math.pow(2, i), o += f) : (a = t * Math.pow(2, f - 1) * Math.pow(2, i), o = 0)); i >= 8; e[r + d] = 255 & a, d += p, a /= 256, i -= 8);
                ...
                h = class extends o.wR {
                    ...
                    async switchChain(e) {
                        ...
                        try {
                            ...
                            if (4902 === s.code || s ? .data ? .originalError ? .code === 4902) try {
                                await t.request({
        ...
        3162: function(e, t, r) {
                    ...
                    if (i) {
                        ...
                        ! function({
                            ...
                            let {
                                ...
                                let o = await Promise.all(s.map(async t => {
                                    let r, n;
                                    let s = t({
                                            chain: e,
                                            retryCount: 0,
                ...
                B = (e, t) => (r, n, i) => {
                        ...
                        h = () => {
                            ...
                            let t = a.partialize({ ...n()
                                ...
                                r = f({
                                    state: t,
                                    version: a.version
                                }).then(e => s.setItem(a.name, e)).catch(t => {
                                    e = t
                                });
                            if (e) throw e;
                            return r
                    ...
                    let p = e((...e) => {
                        ...
                        g = () => {
                            ...
                            return O(s.getItem.bind(s))(a.name).then(e => {
                ...
                x = (e, t) => (r, n, i) => {
                    ...
                    let d = e((...e) => {
                        ...
                        p = () => {
                            ...
                            return O(l.getItem.bind(l))(o.name).then(e => {
                                if (e) {
            ...
            function F(e) {
                ...
                return t = function(e) {
                    ...
                    for (;;) {
                        ...
                        for (;
                            ((o ^ a) & 1073741824) == 0;) h = h << 1 & f | l(), o = o << 1 & f, a = a << 1 & f | 1;
            ...
            for (let {
                    V: e,
                    M: t
                } of ([...ed, ...en()].sort((e, t) => e - t).map((e, t, r) => {
                    let n = z(),
                        i = r[t] = n ? r[t - n] : {
                            V: [],
                            M: new Map
            ...
            let eg = new Set,
                em = new Set;
            for (let e of eh)
                for (let t of e.V)(eg.has(t) ? em : eg).add(t);
...
Read more: https://wagmi.sh/core/providers/jsonRpc`)
                ...
                return {
                    ...
                    webSocketPublicClient: ({
                        ...
                        let h = (0, p.v)({
                            batch: r,
                            chain: c,
                            transport: b(f.map(e => (function(e, t = {}) {
                                let {
                                    key: r = "webSocket",
                                    ...
                                    return (0, y.q)({
                                        ...
                                        async subscribe({
                                            ...
                                            let n = await (0, C.h)(l),
                                                {
                                                    result: i
                                                } = await new Promise((i, s) => C.f.webSocket(n, {
                                                    body: {
                                            ...
                                            return {
                                                subscriptionId: i,
                                                unsubscribe: async () => new Promise(e => C.f.webSocket(n, {
                                                    body: {
            ...
            var eM = class extends Error {
                ...
                eU = (e, {
                    find: t,
                    replace: r
                }) => e && t(e) ? r(e) : "object" != typeof e ? e : Array.isArray(e) ? e.map(e => eU(e, {
                    find: t,
                    replace: r
            ...
            var eG = "store",
                ez = class {
                    constructor({
                        ...
                        publicClient: r,
                        storage: a = eq({
                            storage: "undefined" != typeof window ? window.localStorage : eQ
                        }),
                        logger: c = {
                            warn: console.warn
                        },
                        ...
                        let p;
                        f(this, s), this.publicClients = new Map, this.webSocketPublicClients = new Map, f(this, n, void 0), f(this, i, void 0), this.args = {
                            autoConnect: e,
                            connectors: t,
                            logger: c,
                            publicClient: r,
                        ...
                        m.forEach(e => e.setStorage(a)), this.store = R(I(S(() => ({
                            connectors: m,
                            ...
                            version: 2
                        }))), this.storage = a, h(this, i, a ? .getItem("wallet")), d(this, s, o).call(this), e && "undefined" != typeof window && setTimeout(async () => await this.autoConnect(), 0)
                    }
                    get chains() {
            ...
            n = new WeakMap, i = new WeakMap, s = new WeakSet, o = function() {
                let e = e => {
                        this.setState(t => ({ ...t,
                            data: { ...t.data,
                                ...e
            ...
            async function e0({
                ...
                if (e && s.chain.id !== e) throw new eM({
                    chainId: e
                });
                return s.multicall({
            ...
            async function e2({
                ...
                try {
                    let n = eZ(),
                        ...
                        o = (await Promise.all(Object.entries(s).map(([e, n]) => e0({
                            allowFailure: i,
                            chainId: parseInt(e),
                            contracts: n.map(({
                                contract: e
                        ...
                        a = Object.values(s).flatMap(e => e.map(({
                            index: e
                        }) => e));
                                        ...
                                        for (e = e.slice().reverse(); e.length;) {
                                            let i = function(e, t) {
                                                ...
                                                for (t && (t.length = 0); o;) {
                                                    ...
                                                    s.push(a), i.F && (s.push(65039), o > 0 && 65039 == e[o - 1] && o--), i.V && (r = function(e, t) {
                                                        let r = ev.from(e);
                                                        return 2 == t.V && r.splice(1, 1), r
                                                    }(s, i), t && t.push(...e.slice(o).reverse()), e.length = o)
                                                }
                                                return r
                                            }(e);
                                ...
                                if (s) {
                                    ...
                                    if (!o && r.every(e => e < 128)) t = r, eP(t),
                                        ...
                                        (function(e, t) {
                                            ...
                                            for (let n of t)
                                                if (!r.has(n)) throw eO(e, n);
                                            if (n) {
                                                let e = et(t).map(Y);
                                                for (let t = 1, r = e.length; t < r; t++)
                                                    if (ea.has(e[t])) {
                                                        let n = t + 1;
                                                        for (let i; n < r && ea.has(i = e[n]); n++)
                                                            for (let r = t; r < n; r++)
                                                                if (e[r] == i) throw Error(`non-spacing marks: repeated ${eC(i)}`);
        ...
        8306: function(e, t, r) {
            ...
            let o = {
                ...
                m = {
                    ...
                    setConfig(e) {
                        var t, r;
                        h.initialize(), p.setIsCustomMobile(!!(null == (t = e.mobileWallets) ? void 0 : t.length)), p.setIsCustomDesktop(!!(null == (r = e.desktopWallets) ? void 0 : r.length)), p.setChains(o.client().chains), p.setIsPreferInjected(o.client().isInjectedProviderInstalled() && c.isPreferInjectedFlag()), e.defaultChain && p.setSelectedChain(e.defaultChain), c.setWeb3ModalVersionInStorage(), Object.assign(g, e)
                    }
                },
                y = (0, i.sj)({
                    address: void 0,
                ...
                b = {
                    ...
                    async fetchProfile(e, t) {
                        ...
                        try {
                            ...
                            if (n && i) {
                                ...
                                if (t) {
                                    let r = await o.client().fetchEnsAvatar({
                                        name: t,
                                        chainId: 1
                                    });
                    ...
                    async fetchBalance(e) {
                        try {
                            ...
                            let i = e ? ? y.address;
                            if (i) {
                                let e = await o.client().fetchBalance({
                                    address: i,
                                    token: t
                                });
                                y.balance = {
            ...
            async function v(e, t) {
                let r = new URL(e, w);
                return r.searchParams.append("projectId", m.state.projectId), Object.entries(t).forEach(([e, t]) => {
            ...
            var C = Object.defineProperty,
                ...
                B = (e, t) => {
                    ...
                    if (E)
                        for (var r of E(t)) I.call(t, r) && O(e, r, t[r]);
                    return e
                };
            let x = c.isMobile(),
                S = (0, i.sj)({
                ...
                M = {
                    ...
                    async getRecomendedWallets() {
                        ...
                        if (c.isArray(e)) {
                            ...
                            let e = c.isArray(t),
                                ...
                                {
                                    listings: n
                                } = x ? await A.getMobileListings(r) : await A.getDesktopListings(r);
                    ...
                    async getWallets(e) {
                        ...
                        let {
                            ...
                            listings: a,
                            total: u
                        } = x ? await A.getMobileListings(t) : await A.getDesktopListings(t), l = Object.values(a), f = o ? "search" : "wallets";
                        return S[f] = {
                            listings: [...S[f].listings, ...l],
                            total: u,
                            page: s ? ? 1
                        }, {
                            listings: l,
                    ...
                    async getInjectedWallets() {
                        let {
                            listings: e
                        } = await A.getInjectedListings({}), t = Object.values(e);
                ...
                U = {
                    ...
                    open: async e => new Promise(t => {
                        ...
                        if (j.setPairingEnabled(!0), null != e && e.route) u.reset(e.route);
                            ...
                            o.client().connectConnector("injected", s ? .id).catch(e => console.error(e)), t();
                            return
            ...
            var L = Object.defineProperty,
                ...
                Q = (e, t) => {
                    ...
                    if (D)
                        for (var r of D(t)) T.call(t, r) && N(e, r, t[r]);
                    return e
                };
            let q = (0, i.sj)({
            ...
            "u" > typeof window && (window.Buffer || (window.Buffer = s.lW), window.global || (window.global = window), window.process || (window.process = {
                env: {}
        ...
        7948: function(e, t, r) {
            ...
            var s = Object.defineProperty,
                ...
                l = (e, t) => {
                    ...
                    if (o)
                        for (var r of o(t)) u.call(t, r) && c(e, r, t[r]);
                    return e
                };
            ...
            var h = Object.getOwnPropertySymbols,
                ...
                g = (e, t) => {
                    ...
                    if (null != e && h)
                        for (var n of h(e)) 0 > t.indexOf(n) && p.call(e, n) && (r[n] = e[n]);
                    return r
                };
            let m = (0, n.memo)(function(e) {
                var {
                    ethereumClient: t
                } = e, s = g(e, ["ethereumClient"]);
            ...
            var y = Object.defineProperty,
                ...
                C = (e, t) => {
                    ...
                    if (b)
                        for (var r of b(t)) v.call(t, r) && A(e, r, t[r]);
                    return e
                };
        ...
        6345: function(e, t, r) {
            ...
            let n = Symbol(),
                ...
                h = (e, t, r, o) => {
                    ...
                    let [c, d] = a, p = r && r.get(c);
                    return p && !!d === p[1].f || ((p = ((e, t) => {
                        let r = {
                                f: t
                            },
                            s = !1,
                    ...
                    })(c, !!d))[1].p = s(d || c, p[0]), r && r.set(c, p)), p[1].a = t, p[1].c = r, p[1].t = o, p[1].p
                },
                d = (e, t, r, n) => {
                    ...
                    try {
                        for (let r of i.h || [])
                            if (s = Reflect.has(e, r) !== Reflect.has(t, r)) return s;
                        if (!0 === i.w) {
                            if (s = ((e, t) => {
                            ...
                            for (let r of i.o || [])
                                if (s = !!Reflect.getOwnPropertyDescriptor(e, r) != !!Reflect.getOwnPropertyDescriptor(t, r)) return s;
                        for (let o of i.k || [])
                            if (s = d(e[o], t[o], r, n)) return s;
                        return null === s && (s = !0), s
                    } finally {
                        n && n.set(e, {
                            n: t,
                ...
                y = new WeakMap,
                b = new WeakSet,
                w = (e = Object.is, t = (e, t) => new Proxy(e, t), r = e => m(e) && !b.has(e) && (Array.isArray(e) || !(Symbol.iterator in e)) && !(e instanceof WeakMap) && !(e instanceof WeakSet) && !(e instanceof Error) && !(e instanceof Number) && !(e instanceof Date) && !(e instanceof String) && !(e instanceof RegExp) && !(e instanceof ArrayBuffer), n = e => {
                    switch (e.status) {
                        case "fulfilled":
                            return e.value;
                        case "rejected":
                    ...
                    let c = a[0],
                        ...
                        h = a[1],
                        d = (e = ++a[1]) => (h === e || l.size || (h = e, w.forEach(([t]) => {
                            let r = t[1](e);
                            r > c && (c = r)
                        })), c),
                        g = e => (t, r) => {
                        ...
                        C = e => {
                            l.add(e), 1 === l.size && w.forEach(([e, t], r) => {
                                if (t) throw Error("remove already exists");
                                let n = e[3](g(r));
                                w.set(r, [e, n])
                            });
                            let t = () => {
                                l.delete(e), 0 === l.size && w.forEach(([e, t], r) => {
                                    t && (t(), w.set(r, [e]))
                                })
                            };
                            return t
                    ...
                    o.set(n, I);
                    let O = [E, d, s, C];
                    return y.set(I, O), Reflect.ownKeys(n).forEach(e => {
            ...
            async function y(e, t) {
                ...
                try {
                    ...
                    let n = function(e) {
                        ...
                        } = await r.e(594).then(r.bind(r, 7877));
                    ...
                    throw function(e, {
                        ...
                        let n = e;
                        return (0, h.B)(e) && (n = (0, h.k)(e, r)), new a.cg(n, {
                            docsPath: t,
                            ...r
                        })
                    }(u, { ...t,
            ...
            async function m(e, t) {
                ...
                try {
                    let {
                        ...
                        value: b,
                        ...w
                    } = "local" === o.type ? await (0, g.h)(e, t) : t, v = n ? (0, s.eC)(n) : void 0, A = v || i;
                    (0, p.F)(t);
                    ...
                    throw function(e, {
                        ...
                        let n = e;
                        return (0, f.B)(e) && (n = (0, f.k)(e, r)), new l(n, {
                            docsPath: t,
                            ...r
                        })
                    }(r, { ...t,
        ...
        3089: function(e, t, r) {
            ...
            function d(e, t) {
                ...
                return r instanceof h.Lu && (!!(r.data ? .errorName === "ResolverNotFound" || r.data ? .errorName === "ResolverWildcardNotSupported" || r.reason ? .includes("Wildcard on non-extended resolvers is not supported")) || "reverse" === t && r.reason === l.$[50])
            }
            var p = r(4840),
                g = r(9750),
                m = r(9550),
            ...
            function v(e) {
                ...
                for (let e = 0; e < i.length; e++) {
                    let t = (0, g.qX)(i[e]);
                    t.byteLength > 255 && (t = (0, g.qX)(`[${(function(e){let t=new Uint8Array(32).fill(0);return e?b(e)||(0,m.w)((0,g.qX)(e)):(0,c.ci)(t)})(i[e]).slice(2)}]`)), r[n] = t.length, r.set(t, n + 1), n += t.length + 1
                }
            ...
            function C(e, {
                ...
                let {
                    ...
                    message: c,
                    shortMessage: l
                } = e instanceof h.VQ ? e : e instanceof f.G ? e.walk(e => "data" in e) || e.walk() : {}, d = e;
                return e instanceof A.wb ? d = new h.Dk({
                    functionName: s
                }) : 3 === a && (u || c || l) && (d = new h.Lu({
                    abi: t,
            ...
            async function I(e, {
                ...
                try {
                    ...
                    let d = (0, u.f)((0, s.k)({
                        abi: i.X$,
                        args: null != n ? [w(l), BigInt(n)] : void 0,
                        functionName: "addr",
                        data: f[0]
                    }));
            ...
            async function Q(e, {
                ...
                if ("erc721" === t.namespace) return P(e, {
                ...
                if ("erc1155" === t.namespace) return P(e, {
                    address: t.contractAddress,
                    abi: [{
                        name: "uri",
                        type: "function",
            ...
            async function G(e, {
                ...
                let n = function(e) {
                        ...
                        let [r, n, i] = t.split("/"), [s, o] = r.split(":"), [a, u] = n.split(":");
                        if (!s || "eip155" !== s.toLowerCase()) throw new B({
                ...
                let u = n.tokenID;
                return "erc1155" === n.namespace && (u = u.replace("0x", "").padStart(64, "0")), T({
                    gatewayUrls: t,
            ...
            function et({
                ...
                if ("event" !== n.type) throw new A.mv(void 0, {
                    docsPath: "/docs/contract/encodeEventTopics"
                });
                let i = (0, _.t)(n),
                    s = X(i),
                ...
                if (r && "inputs" in n) {
                    ...
                    t.length > 0 && (o = e ? .map((e, r) => Array.isArray(t[r]) ? t[r].map((n, i) => er({
                        param: e,
                        value: t[r][i]
                    })) : t[r] ? er({
                        param: e,
            ...
            function eE({
                ...
                if (!(a && "name" in a) || "event" !== a.type) throw new A.lC(s, {
                    docsPath: eC
                });
                let {
                    name: u,
                    inputs: c
                } = a, l = c ? .some(e => !("name" in e && e.name)), f = l ? [] : {}, h = c.filter(e => "indexed" in e && e.indexed);
                if (o.length > 0)
                    ...
                    if (t && "0x" !== t) try {
                        ...
                        if (e) {
                            if (l) f = [...f, ...e];
                                ...
                                for (let t = 0; t < d.length; t++) f[d[t].name] = e[t]
                        }
                    } catch (e) {
                        if (i) {
            ...
            async function ex(e, {
                ...
                let l = u ? ? !1,
                    f = o ? ? (s ? [s] : void 0),
                    h = [];
                return f && (h = [f.flatMap(e => et({
                    abi: [e],
                    eventName: e.name,
                    args: a
                }))], s && (h = h[0])), (r ? await e.request({
                    method: "eth_getLogs",
                    params: [{
                        address: t,
                        topics: h,
            ...
            async function ek(e, {
                ...
                let [n, i] = await Promise.all([eg(e), t ? ej(e, {
                    hash: t
                }) : void 0]), s = r ? .blockNumber || i ? .blockNumber;
            ...
            async function eF(e, t) {
                let {
                    ...
                    contracts: l,
                    multicallAddress: f
                } = t, d = n ? ? ("object" == typeof e.batch ? .multicall && e.batch.multicall.batchSize || 1024), p = f;
                if (!p) {
                ...
                for (let e = 0; e < l.length; e++) {
                    ...
                    try {
                        ...
                        y += e.length, d > 0 && y > d && (m++, y = (e.length - 2) / 2, g[m] = []), g[m] = [...g[m], {
                            allowFailure: !0,
                            callData: e,
                            target: n
                        }]
                ...
                let b = await Promise.all(g.map(t => P(e, {
                    abi: i.F8,
                    address: p,
                    args: [t],
                    blockNumber: u,
            ...
            BigInt(0), BigInt(1), BigInt(2), Array.from({
                length: 256
...
${r.length}`);
            ...
            async function eK(e, {
                ...
                let u = function({
                    ...
                    let i = void 0 === e ? {} : e,
                        s = {
                            EIP712Domain: ["string" == typeof i ? .name && {
                                name: "name",
                                type: "string"
                            }, i ? .version && {
                                name: "version",
                    ...
                    return eY(s, {
                        ...
                        try {
                            ...
                            if (a) {
                                if (t === a) return;
                                if (t - a > 1 && r)
                                    for (let e = a + 1 n; e < t; e++) n.onBlockNumber(e, a), a = e
                    ...
                    let d = eY(c, {
                        ...
                        let s = e0(e, {
                            ...
                            async onBlockNumber(i) {
                                ...
                                try {
                                    if (u) {
                                        if (c - u.blockNumber + 1 n < t) return;
                                        f(() => n.resolve(u));
                                        return
                                    }
                                    if (o || (l = !0, await (0, eZ.J)(async () => {
                                            (o = await ej(e, {
                                                hash: r
                                            })).blockNumber && (c = o.blockNumber)
                                        }, {
                                            delay: ({
                                                count: e
                                            }) => 200 * ~~(1 << e),
                                            ...
                                            hash: r
                                        }), t > 0 && c - u.blockNumber + 1 n < t) return;
                                    f(() => n.resolve(u))
                                } catch (r) {
                                    if (o && (r instanceof eM.Bh || r instanceof eM.Yb)) {
                                        a = o;
                                        let r = await (0, el.Q)(e, {
                                                blockNumber: c,
                                        ...
                                        if (!i || c - (u = await eD(e, {
                                                hash: i.hash
                                            })).blockNumber + 1 n < t) return;
                                        let s = "replaced";
                                        i.to === a.to && i.value === a.value ? s = "repriced" : i.from === i.to && 0 n === i.value && (s = "cancelled"), f(() => {
                                            n.onReplaced ? .({
                                                reason: s,
        ...
        1179: function(e, t, r) {
            ...
            async function y(e, t) {
                ...
                try {
                    let r;
                    if ((0, g.F)(t), null !== n && (r = await (0, i.L)(e), (0, l.qg)({
                            currentChainId: r,
                            chain: n
                        })), "local" === P.type) {
                        let t = await (0, m.h)(e, {
                    ...
                    throw function(e, {
                        ...
                        let n = e;
                        return (0, h.B)(e) && (n = (0, h.k)(e, r)), new f.mk(n, {
                            docsPath: t,
                            ...r
                        })
                    }(e, { ...t,
            ...
            async function B(e, {
                ...
                let o = (0, u.T)(t),
                    a = {
                        EIP712Domain: ["string" == typeof r ? .name && {
                            name: "name",
                            type: "string"
                        }, r ? .version && {
                            name: "version",
            ...
            function u(e, t = {}) {
                ...
                return ({
                    ...
                    let {
                        batchSize: g = 1e3,
                        wait: m = 0
                    } = "object" == typeof r ? r : {}, y = t.retryCount ? ? d, b = p ? ? t.timeout ? ? 1e4, w = e || h ? .rpcUrls.default.http[0];
                    if (!w) throw new i.I;
                    return (0, a.q)({
                        key: c,
                        name: l,
                        async request({
                            ...
                            let a = {
                                ...
                                l = async e => r ? c(e) : [await o.f.http(w, {
                                    body: e,
                                    fetchOptions: u,
                                    timeout: b
                                })],
        ...
        5402: function(e, t, r) {
            ...
            class i extends Error {
                constructor(e, t = {}) {
                    ...
                    this.message = [e || "An error occurred.", "", ...t.metaMessages ? [...t.metaMessages, ""] : [], ...s ? [`Docs: https://viem.sh${s}.html${t.docsSlug?`#${t.docsSlug}`:""}`] : [], ...r ? [`Details: ${r}`] : [], `Version: ${this.version}`].join("\n"), t.cause && (this.cause = t.cause), this.details = r, this.docsPath = s, this.metaMessages = t.metaMessages, this.shortMessage = e
                }
                walk(e) {
                    return function e(t, r) {
                ...
                constructor(e, {
                    ...
                    let l = (0, c.m)({
                        ...
                        d = (0, p.xr)({
                            address: n && (0, g.CR)(n),
                            function: h,
                            args: f && "()" !== f && `${[...Array(s?.length??0).keys()].map(()=>" ").join("")}${f}`,
                            sender: a
                        });
                    ...
                    }), this.abi = t, this.args = r, this.cause = e, this.contractAddress = n, this.functionName = s, this.sender = a
                }
            }
            class b extends d.G {
                constructor({
                    ...
                    a instanceof h.yP && (c = [`Unable to decode signature "${f=a.signature}" as it was not found on the provided ABI.`, "Make sure you are using the correct ABI and that the error exists on it.", `You can look up the decoded signature here: https://openchain.xyz/signatures?query=${f}.`]), super(l && "execution reverted" !== l || f ? [`The contract function "${r}" reverted with the following ${f?"signature":"reason"}:`, l || f].join("\n") : `The contract function "${r}" reverted.`, {
                        ...
                        writable: !0,
                        value: void 0
                    }), this.data = d, this.reason = l, this.signature = f
                }
            }
            class w extends d.G {
                constructor({
...
Try increasing the nonce or find the latest nonce with \`getTransactionCount\`.`, {
            ...
            class o extends i.G {
                constructor({
                    ...
                    super("HTTP request failed.", {
                        details: t,
                        metaMessages: [i && `Status: ${i}`, `URL: ${(0,s.Gr)(o)}`, e && `Request body: ${(0,n.P)(e)}`].filter(Boolean)
                    }), Object.defineProperty(this, "name", {
                        enumerable: !0,
                        configurable: !0,
                        writable: !0,
                        ...
                        writable: !0,
                        value: void 0
                    }), this.body = e, this.headers = r, this.status = i, this.url = o
                }
            }
            class a extends i.G {
                constructor({
                    ...
                    super("WebSocket request failed.", {
                        details: t,
                        metaMessages: [`URL: ${(0,s.Gr)(r)}`, `Request body: ${(0,n.P)(e)}`]
                    }), Object.defineProperty(this, "name", {
                        enumerable: !0,
                        configurable: !0,
                        writable: !0,
            ...
            class c extends i.G {
                constructor({
                    ...
                    super("The request took too long to respond.", {
                        ...
                        metaMessages: [`URL: ${(0,s.Gr)(t)}`, `Request body: ${(0,n.P)(e)}`]
                    }), Object.defineProperty(this, "name", {
                        enumerable: !0,
                        configurable: !0,
                        writable: !0,
        ...
        7240: function(e, t, r) {
            ...
            class h extends s.G {
                constructor({
                    ...
                    let s = "Transaction";
                    r && void 0 !== i && (s = `Transaction at block time "${r}" at index "${i}"`), e && void 0 !== i && (s = `Transaction at block hash "${e}" at index "${i}"`), t && void 0 !== i && (s = `Transaction at block number "${t}" at index "${i}"`), n && (s = `Transaction with hash "${n}"`), super(`${s} could not be found.`), Object.defineProperty(this, "name", {
                        enumerable: !0,
                        configurable: !0,
                        writable: !0,
        ...
        9866: function(e, t, r) {
            ...
            function l(e, t) {
                ...
                if ((0, s.d)(t) && 32 > (0, s.d)(t)) throw new n.xB({
                    data: t,
                    params: e,
                    size: (0, s.d)(t)
                });
                        ...
                        let d = t[h],
                            {
                                ...
                                if (l) {
                                    ...
                                    return function(t, {
                                        ...
                                        if (!n) {
                                            let n = (0, u.ly)((0, o.tP)(t, i, i + 32, {
                                                    strict: !0
                                                })),
                                                s = (0, u.ly)((0, o.tP)(t, n, n + 32, {
                                                    strict: !0
                                                })),
                                                a = 0,
                                                c = [];
                                ...
                                if ("string" === r.type) return function(e, {
                                    ...
                                    let r = (0, u.ly)((0, o.tP)(e, t, t + 32, {
                                            strict: !0
                                        })),
                                        n = (0, u.ly)((0, o.tP)(e, r, r + 32, {
                                            strict: !0
                                        }));
                                    if (0 === n) return {
                                        consumed: 32,
                                    ...
                                    let i = (0, u.rR)((0, a.f)((0, o.tP)(e, r + 32, r + 32 + n, {
                                        strict: !0
                                    })));
                                    return {
                                        consumed: 32,
                                ...
                                if (r.type.startsWith("bytes")) return function(e, {
                                    ...
                                    if (!i) {
                                        let t = (0, u.ly)((0, o.tP)(e, r, r + 32, {
                                                strict: !0
                                            })),
                                            n = (0, u.ly)((0, o.tP)(e, t, t + 32, {
                                                strict: !0
                                            }));
                                        if (0 === n) return {
                                            consumed: 32,
        ...
        1258: function(e, t, r) {
            ...
            function c({
                ...
                if (!l) throw new i.yP(r, {
                    docsPath: "/docs/contract/decodeErrorResult"
                });
                return {
                    abiItem: l,
                    args: "inputs" in l && l.inputs && l.inputs.length > 0 ? (0, a.r)(l.inputs, (0, s.tP)(t, 4)) : void 0,
                    errorName: l.name
                }
            }
        },
                        ...
                        for (let f = 0; f < e.length; f++) r.push(function e({
                            ...
                            if (f) {
                                ...
                                return function(t, {
                                    ...
                                    if (!s && t.length !== r) throw new n.gr({
                                        expectedLength: r,
                                        givenLength: t.length,
                                        type: `${i.type}[${r}]`
                                    });
                            ...
                            if ("address" === t.type) return function(e) {
                                ...
                                return {
                                    dynamic: !1,
                                    encoded: (0, a.gc)(e.toLowerCase())
                                }
                            }(r);
                            if ("bool" === t.type) return {
                                dynamic: !1,
                                encoded: (0, a.gc)((0, l.C4)(r))
                            };
                            ...
                            if (t.type.startsWith("bytes")) return function(e, {
                                ...
                                if (!r) {
                                    let t = e;
                                    return i % 32 != 0 && (t = (0, a.gc)(t, {
                                        dir: "right",
                                        size: 32 * Math.ceil((e.length - 2) / 2 / 32)
                                    })), {
                                        dynamic: !0,
                                        encoded: (0, o.zo)([(0, a.gc)((0, l.eC)(i, {
                                            size: 32
                                        })), t])
                                    }
                                }
                            ...
                            if ("string" === t.type) return function(e) {
                                let t = (0, l.$G)(e),
                                    ...
                                    n = [];
                                for (let e = 0; e < r; e++) n.push((0, a.gc)((0, c.tP)(t, 32 * e, (e + 1) * 32), {
                                    dir: "right"
                                }));
                                return {
                                    dynamic: !0,
                                    encoded: (0, o.zo)([(0, a.gc)((0, l.eC)((0, u.d)(t), {
                                        size: 32
                                    })), ...n])
                                }
                            }(r);
                            ...
                            return !!i && function e(t, r) {
                                ...
                                switch (s) {
                                    ...
                                    default:
                                        ...
                                        if (/[a-z]+[1-9]{0,3}(\[[0-9]{0,}\])+$/.test(s)) return Array.isArray(t) && t.every(t => e(t, { ...r,
        ...
        4594: function(e, t, r) {
            ...
            var n = r(5402),
                ...
                s = r(7224),
                o = r(788);
            let a = e => "code" in e ? -1 !== e.code && -32004 !== e.code && -32005 !== e.code && -32042 !== e.code && -32603 !== e.code : e instanceof i.Gg && !!e.status && 403 !== e.status && 408 !== e.status && 413 !== e.status && 429 !== e.status && 500 !== e.status && 502 !== e.status && 503 !== e.status && 504 !== e.status;

            function u(e, {
                retryDelay: t = 150,
                retryCount: r = 3
            } = {}) {
                return async u => (0, o.J)(async () => {
                    try {
                        return await e(u)
                    } catch (e) {
                        switch (e.code) {
        ...
        1742: function(e, t, r) {
            ...
            function a(e, t) {
                if ("number" == typeof t && t > 0 && t > (0, s.d)(e) - 1) throw new n.m({
                    offset: t,
                    position: "start",
                    size: (0, s.d)(e)
                })
            ...
            function u(e, t, r) {
                if ("number" == typeof t && "number" == typeof r && (0, s.d)(e) !== r - t) throw new n.m({
                    offset: r,
                    position: "end",
                    size: (0, s.d)(e)
                })
        ...
        8405: function(e, t, r) {
            ...
            function u(e, t = {}) {
                ...
                if (!r) return n;
                let i = (e.length - 2) / 2,
                    s = (1 n << 8 n * BigInt(i) - 1 n) - 1 n;
                return n <= s ? n : n - BigInt(`0x${"f".padStart(2*i,"f")}`) - 1 n
            }
            ...
            function c(e, t = {}) {
                ...
                if (t.size && (a(r, {
                        size: t.size
                    }), r = (0, s.f)(r)), "0x00" === (0, s.f)(r)) return !1;
        ...
        471: function(e, t, r) {
            ...
            function l(e, t = {}) {
                ...
                o ? r = s ? (1 n << 8 n * BigInt(o) - 1 n) - 1 n : 2 n ** (8 n * BigInt(o)) - 1 n : "number" == typeof e && (r = BigInt(Number.MAX_SAFE_INTEGER));
                let u = "bigint" == typeof r && s ? -r - 1 n : 0;
                if (r && a > r || a < u) {
        ...
        6678: function(e, t, r) {
            ...
            function a(e, t) {
                ...
                if (n.Hh.nodeMessage.test(r)) return new n.Hh({
                    cause: e,
                    maxFeePerGas: t ? .maxFeePerGas
                });
                if (n.G$.nodeMessage.test(r)) return new n.G$({
                    cause: e,
                    maxFeePerGas: t ? .maxFeePerGas
                });
                if (n.ZI.nodeMessage.test(r)) return new n.ZI({
                    cause: e,
                    nonce: t ? .nonce
                });
                if (n.vU.nodeMessage.test(r)) return new n.vU({
                    cause: e,
                    nonce: t ? .nonce
                });
                if (n.se.nodeMessage.test(r)) return new n.se({
                    cause: e,
                    nonce: t ? .nonce
                });
                if (n.C_.nodeMessage.test(r)) return new n.C_({
                    cause: e
                });
                if (n.WF.nodeMessage.test(r)) return new n.WF({
                    cause: e,
                    gas: t ? .gas
                });
                else if (n.dR.nodeMessage.test(r)) return new n.dR({
                    cause: e,
                    gas: t ? .gas
                });
                else if (n.pZ.nodeMessage.test(r)) return new n.pZ({
                    cause: e
                });
                else if (n.cs.nodeMessage.test(r)) return new n.cs({
                    cause: e,
                    maxFeePerGas: t ? .maxFeePerGas,
                    maxPriorityFeePerGas: t ? .maxPriorityFeePerGas
                });
                else if (r.match(n.M_.nodeMessage) || "code" in e.cause && e.cause ? .code === n.M_.code) return new n.M_({
                    cause: e,
                    message: e.cause.details || e.details
                });
                return new n.cj({
                    cause: e.cause.cause
                })
        ...
        9550: function(e, t, r) {
            ...
            let [p, g, m] = [
                ...
                [],
                []
            ], y = BigInt(0), b = BigInt(1), w = BigInt(2), v = BigInt(7), A = BigInt(256), C = BigInt(113);
            ...
            let [E, P] = c.split(m, !0), I = (e, t, r) => r > 32 ? c.rotlBH(e, t, r) : c.rotlSH(e, t, r), O = (e, t, r) => r > 32 ? c.rotlBL(e, t, r) : c.rotlSL(e, t, r);
            class B extends d {
                constructor(e, t, r, n = !1, i = 24) {
                    if (super(), this.blockLen = e, this.suffix = t, this.outputLen = r, this.enableXOF = n, this.rounds = i, this.pos = 0, this.posOut = 0, this.finished = !1, this.destroyed = !1, s.number(r), 0 >= this.blockLen || this.blockLen >= 200) throw Error("Sha3 supports only keccak-f1600 function");
                ...
                _cloneInto(e) {
                    ...
                    return e || (e = new B(t, r, n, s, i)), e.state32.set(this.state32), e.pos = this.pos, e.posOut = this.posOut, e.finished = this.finished, e.rounds = i, e.suffix = r, e.outputLen = n, e.enableXOF = s, e.destroyed = this.destroyed, e
                }
            }
            let x = (e, t, r) => (function(e) {
        ...
        7795: function(e, t, r) {
            ...
            async function u(e, {
                ...
                try {
                    ...
                    if (f = h.headers.get("Content-Type") ? .startsWith("application/json") ? await h.json() : await h.text(), !h.ok) throw new n.Gg({
                        body: t,
                        details: (0, o.P)(f.error) || h.statusText,
                        headers: h.headers,
                        status: h.status,
                        url: e
                    });
            ...
            async function l(e) {
                ...
                let {
                    ...
                    fn: async () => {
                        ...
                        return i.addEventListener("close", l), i.addEventListener("message", u), i.readyState === e.CONNECTING && await new Promise((e, t) => {
            ...
            async function f(e, {
                ...
                return s(() => new Promise(r => h.webSocket(e, {
                    body: t,
                    onResponse: r
                })), {
                    errorInstance: new n.W5({
            ...
            let h = {
                ...
                webSocket: function(e, {
                    ...
                    if (e.readyState === e.CLOSED || e.readyState === e.CLOSING) throw new n.c9({
                        body: t,
                        url: e.url,
                    ...
                    return e.requests.set(i, s), e.send(JSON.stringify({
                        jsonrpc: "2.0",
                        ...t,
                        id: i
                    })), e
        ...
        894: function(e, t, r) {
            ...
            function u(e) {
                ...
                if (u && u > 2 n ** 256 n - 1 n) throw new s.Hh({
                    maxFeePerGas: u
                });
                if (c && u && c > u) throw new s.cs({
                    maxFeePerGas: u,
                    maxPriorityFeePerGas: c
                })
            }
        ...
        3535: function(e, t, r) {
            ...
            async function f(e, t) {
                ...
                if (void 0 === g && (b.nonce = await (0, a.K)(e, {
                        address: m.address,
                        blockTag: "pending"
                    })), "bigint" == typeof y.baseFeePerGas) {
                    if (void 0 !== h) throw new c.G("Chain does not support legacy `gasPrice`.");
                    if (void 0 === d) b.maxPriorityFeePerGas = p ? ? 1500000000 n, b.maxFeePerGas = 120 n * y.baseFeePerGas / 100 n + b.maxPriorityFeePerGas;
                    else {
                        if (void 0 === p && d < 1500000000 n) throw new c.G("`maxFeePerGas` cannot be less than the default `maxPriorityFeePerGas` (1.5 gwei).");
                        b.maxFeePerGas = d, b.maxPriorityFeePerGas = p ? ? 1500000000 n
                    }
                } else {
                    if (void 0 !== d || void 0 !== p) throw new c.G("Chain does not support EIP-1559 fees.");
                    void 0 === h && (b.gasPrice = await (0, o.o)(e) * 120 n / 100 n)
                }
                return void 0 === f && (b.gas = await (0, i.Q)(e, { ...b,
                    account: {
                        address: m.address,
                        type: "json-rpc"
                    }
            ...
            function l({
                ...
                let f = (e, t) => {
                    for (let r of e) {
                        ...
                        if ("address" === h && "string" == typeof d && !(0, s.U)(d)) throw new i.b({
                            address: d
                        });
                        let g = h.match(u);
                        if (g) {
                            let [e, t] = g;
                            if (t && (0, o.d)(d) !== parseInt(t)) throw new n.KY({
        ...
        9652: function(e, t, r) {
            ...
            function c(e, t, r) {
                return A(e) ? "function" == typeof t ? { ...r,
                    queryKey: e,
                    queryFn: t
                } : { ...t,
                    queryKey: e
                    ...
                    h = () => {
                        ...
                        if (!o) {
                            ...
                            Promise.resolve(t).then(c).catch(t => {
                                ...
                                s++, null == e.onFail || e.onFail(s, t), C(d).then(() => {
                                    if (u()) return f()
                                }).then(() => {
                                    i ? l(t) : h()
                                })
            ...
            class F extends D {
                constructor(e) {
                    super(), this.abortSignalConsumed = !1, this.defaultOptions = e.defaultOptions, this.setOptions(e.options), this.observers = [], this.cache = e.cache, this.logger = e.logger || I, this.queryKey = e.queryKey, this.queryHash = e.queryHash, this.initialState = e.state || function(e) {
                ...
                fetch(e, t) {
                    ...
                    u(c), null == (r = this.options.behavior) || r.onFetch(c), this.revertState = this.state, ("idle" === this.state.fetchStatus || this.state.fetchMeta !== (null == (n = c.fetchOptions) ? void 0 : n.meta)) && this.dispatch({
                        type: "fetch",
                        meta: null == (s = c.fetchOptions) ? void 0 : s.meta
                    });
                    let l = e => {
                        if (U(e) && e.silent || this.dispatch({
                                type: "error",
                                error: e
                            }), !U(e)) {
                            var t, r, n, i;
            ...
            class N extends D {
                constructor(e) {
                    super(), this.defaultOptions = e.defaultOptions, this.mutationId = e.mutationId, this.mutationCache = e.mutationCache, this.logger = e.logger || I, this.observers = [], this.state = e.state || Q(), this.setOptions(e.options), this.scheduleGc()
                }
                setOptions(e) {
                    this.options = { ...this.defaultOptions,
                        ...e
                ...
                async execute() {
                    ...
                    try {
                        ...
                        try {
                            throw await (null == (h = (d = this.mutationCache.config).onError) ? void 0 : h.call(d, e, this.state.variables, this.state.context, this)), await (null == (p = (g = this.options).onError) ? void 0 : p.call(g, e, this.state.variables, this.state.context)), await (null == (m = (y = this.mutationCache.config).onSettled) ? void 0 : m.call(y, void 0, e, this.state.variables, this.state.context, this)), await (null == (b = (w = this.options).onSettled) ? void 0 : b.call(w, void 0, e, this.state.variables, this.state.context)), e
                        } finally {
                            this.dispatch({
                                type: "error",
                                error: e
            ...
            class z {
                constructor(e = {}) {
                    this.queryCache = e.queryCache || new T, this.mutationCache = e.mutationCache || new q, this.logger = e.logger || I, this.defaultOptions = e.defaultOptions || {}, this.queryDefaults = [], this.mutationDefaults = [], this.mountCount = 0
                }
                mount() {
                    this.mountCount++, 1 === this.mountCount && (this.unsubscribeFocus = x.subscribe(() => {
                ...
                resetQueries(e, t, r) {
                    let [n, i] = f(e, t, r), s = this.queryCache, o = {
                        type: "active",
                        ...n
                    };
                    return O.batch(() => (s.findAll(n).forEach(e => {
                        e.reset()
                ...
                refetchQueries(e, t, r) {
                    let [n, i] = f(e, t, r), s = O.batch(() => this.queryCache.findAll(n).filter(e => !e.isDisabled()).map(e => {
                        var t;
                    ...
                    if (s) {
                        if (s.timestamp) {
                            let o = Date.now() - s.timestamp > r,
                                a = s.buster !== n;
                            o || a ? t.removeClient() : function(e, t, r) {
                                ...
                                s.forEach(t => {
                                    ...
                                    i.build(e, { ...null == r ? void 0 : null == (n = r.defaultOptions) ? void 0 : n.queries,
                                        queryKey: t.queryKey,
            ...
            let et = ({
                ...
                er = ({
                    ...
                    let i = ee(r, n);
                    return X.createElement(_.Provider, {
                        value: !r && n
            ...
            class ec extends B {
                ...
                setOptions(e) {
                    var t;
                    let r = this.options;
                    this.options = this.client.defaultMutationOptions(e), y(r, this.options) || this.client.getMutationCache().notify({
            ...
            class ef extends B {
                ...
                setOptions(e, t) {
                    let r = this.options,
                        n = this.currentQuery;
                    if (this.options = this.client.defaultQueryOptions(e), y(r, this.options) || this.client.getQueryCache().notify({
                            type: "observerOptionsUpdated",
                    ...
                    i && ep(this.currentQuery, n, this.options, r) && this.executeFetch(), this.updateResult(t), i && (this.currentQuery !== n || this.options.enabled !== r.enabled || this.options.staleTime !== r.staleTime) && this.updateStaleTimeout();
                ...
                updateRefetchInterval(e) {
                    this.clearRefetchInterval(), this.currentRefetchInterval = e, !s && !1 !== this.options.enabled && a(this.currentRefetchInterval) && 0 !== this.currentRefetchInterval && (this.refetchIntervalId = setInterval(() => {
            ...
            function eP(e, t, r) {
                ...
                return function(e, t, r) {
                    ...
                    let u = eu(X.useCallback(e => a.subscribe(O.batchCalls(e)), [a]), () => a.getCurrentResult(), () => a.getCurrentResult()),
                        c = X.useCallback((e, t) => {
            ...
            function eI(e, t, r) {
                let n = Array.isArray(e) ? "function" == typeof t ? { ...r,
                    ...
                    i = function(e, t) {
                        ...
                        a._optimisticResults = s ? "isRestoring" : "optimistic", a.onError && (a.onError = O.batchCalls(a.onError)), a.onSuccess && (a.onSuccess = O.batchCalls(a.onSuccess)), a.onSettled && (a.onSettled = O.batchCalls(a.onSettled)), a.suspense && "number" != typeof a.staleTime && (a.staleTime = 1e3), (a.suspense || a.useErrorBoundary) && !o.isReset() && (a.retryOnMount = !1);
                        let [u] = X.useState(() => new t(i, a)), c = u.getOptimisticResult(a);
                        if (eA(X.useCallback(e => s ? () => void 0 : u.subscribe(O.batchCalls(e)), [u, s]), () => u.getCurrentResult(), () => u.getCurrentResult()), X.useEffect(() => {
                                o.clearReset()
                            }, [o]), X.useEffect(() => {
                                u.setOptions(a, {
                                    listeners: !1
                                })
                            }, [a, u]), a.suspense && c.isLoading && c.isFetching && !s) throw u.fetchOptimistic(a).then(({
                            data: e
                        }) => {
                ...
                return i.defaultedOptions.notifyOnChangeProps ? s : function(e, t) {
                    let r = {};
            ...
            function eB({
                ...
                return (0, em.useSyncExternalStoreWithSelector)(t => (0, Z.pC)({
                    chainId: e
                }, t), () => (0, Z.uV)({
                    chainId: e
                }), () => (0, Z.uV)({
            ...
            function ej({
                ...
                let r = X.useCallback(r => {
                        let n = (0, Z.iE)(),
                            i = n.subscribe(e => ({
                                address: e.data ? .account,
                                connector: e.connector,
                                status: e.status
                            }), (n, i) => (e && "connected" !== i.status && "connected" === n.status && e({
                                address: n.address,
                                connector: n.connector,
                                isReconnected: "reconnecting" === i.status
                            }), t && "connected" === i.status && "disconnected" === n.status && t(), r((0, Z.D0)())));
                        return i
                    }, [e, t]),
                    n = function(e, t, r = t, n = Z.vZ) {
                        let i = X.useRef([]),
                            s = (0, em.useSyncExternalStoreWithSelector)(e, t, r, e => e, (e, t) => {
                ...
                return X.useEffect(() => {
                    e && void 0 === i.current && "connected" === a && e({
                        address: s,
                        connector: o,
                        isReconnected: !0
                    }), i.current = a
            ...
            function eU({
                ...
                return ! function({
                    ...
                    let n = eO(),
                        i = X.useCallback(() => n.invalidateQueries({
                            queryKey: r
                        }, {
                            cancelRefetch: !1
                        }), [n, r]);
                    ! function({
                        ...
                        let f = ex({
                            ...
                            d = function({
                                ...
                                return (0, em.useSyncExternalStoreWithSelector)(t => (0, Z.fq)({
                                    chainId: e
                                }, t), () => (0, Z.jr)({
                                    chainId: e
                                }), () => (0, Z.jr)({
